...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - replace all instances of the `github.com/cristiGuranIonos/pulumi-ionoscloud` repository with the `REPOSITORY` location
...
- binary: pulumi-resource-ionoscloud
  ...
  ignore: []
  ldflags:
  - -X github.com/cristiGuranIonos/pulumi-ionoscloud/provider/pkg/version.Version={{.Tag}}
