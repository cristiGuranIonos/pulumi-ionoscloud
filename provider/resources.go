...
import (
	...
	ionoscloud "github.com/ionos-cloud/terraform-provider-ionoscloud/v6/ionoscloud"

	"github.com/cristiGuranIonos/pulumi-ionoscloud/provider/pkg/version"
)
...
const (
	...
	computeMod = "compute" // the ionoscloud module
)
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		PluginDownloadURL: "github.com/cristiGuranIonos/pulumi-ionoscloud",
		...
		Repository:              "https://github.com/cristiGuranIonos/pulumi-ionoscloud",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: path.Join(
				"github.com/cristiGuranIonos/pulumi-ionoscloud/sdk/",
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			"ionoscloud_datacenter": {
				Tok: tfbridge.MakeResource(mainPkg, computeMod, "Datacenter"),
			},
		},
	}
