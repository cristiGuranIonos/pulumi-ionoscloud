...
func NewDatacenter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ionoscloud:index/datacenter:Datacenter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDatacenter(ctx *pulumi.Context,
	...
	var resource Datacenter
	err := ctx.ReadResource("ionoscloud:index/datacenter:Datacenter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
