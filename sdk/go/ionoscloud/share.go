...
func NewShare(ctx *pulumi.Context,
	...
	var resource Share
	err := ctx.RegisterResource("ionoscloud:index/share:Share", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetShare(ctx *pulumi.Context,
	...
	var resource Share
	err := ctx.ReadResource("ionoscloud:index/share:Share", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
