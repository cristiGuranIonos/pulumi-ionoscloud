...
func NewCubeServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ionoscloud:index/cubeServer:CubeServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCubeServer(ctx *pulumi.Context,
	...
	var resource CubeServer
	err := ctx.ReadResource("ionoscloud:index/cubeServer:CubeServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
