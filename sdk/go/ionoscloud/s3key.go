...
func NewS3Key(ctx *pulumi.Context,
	...
	var resource S3Key
	err := ctx.RegisterResource("ionoscloud:index/s3Key:S3Key", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetS3Key(ctx *pulumi.Context,
	...
	var resource S3Key
	err := ctx.ReadResource("ionoscloud:index/s3Key:S3Key", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
