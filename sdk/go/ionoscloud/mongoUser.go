...
func NewMongoUser(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("ionoscloud:index/mongoUser:MongoUser", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMongoUser(ctx *pulumi.Context,
	...
	var resource MongoUser
	err := ctx.ReadResource("ionoscloud:index/mongoUser:MongoUser", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
