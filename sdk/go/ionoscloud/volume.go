...
//				return err
//			}
//			_, err = ionoscloud.NewVolume(ctx, "exampleIndex/volumeVolume", &ionoscloud.VolumeArgs{
//				DatacenterId:     exampleDatacenter.ID(),
//				ServerId:         exampleServer.ID(),
//				AvailabilityZone: pulumi.String("ZONE_1"),
//				Size:             pulumi.Int(5),
...
func NewVolume(ctx *pulumi.Context,
	...
	var resource Volume
	err := ctx.RegisterResource("ionoscloud:index/volume:Volume", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVolume(ctx *pulumi.Context,
	...
	var resource Volume
	err := ctx.ReadResource("ionoscloud:index/volume:Volume", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
