...
// The image alias.
func (o LookupVolumeResultOutput) ImageAlias() pulumi.StringOutput {
	return o.ApplyT(func(v LookupVolumeResult) string { return v.ImageAlias }).(pulumi.StringOutput)
}
